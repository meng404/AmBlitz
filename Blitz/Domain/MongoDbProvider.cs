...
namespace Blitz.Domain
{
    public class MongoDbProvider : IMongoDbProvider 
    {
        ...
        private readonly BlitzConfiguration _easyDoConfiguration;
        private readonly EntityManager _entityManager;

        public MongoDbProvider(BlitzConfiguration easyDoConfiguration, EntityManager entityManager)
        {
